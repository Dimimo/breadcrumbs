...
namespace Dimimo\Breadcrumbs;

use Dimimo\Breadcrumbs\Exceptions\DuplicateBreadcrumbException;
use Dimimo\Breadcrumbs\Exceptions\InvalidBreadcrumbException;
use Dimimo\Breadcrumbs\Exceptions\UnnamedRouteException;
use Dimimo\Breadcrumbs\Exceptions\ViewNotSetException;
...
class BreadcrumbsManager
{
     ...
     * @return void
     * @throws \Dimimo\Breadcrumbs\Exceptions\DuplicateBreadcrumbException If the given name has already been
     *     used.
     */
     ...
     * @throws \Dimimo\Breadcrumbs\Exceptions\UnnamedRouteException if no name is given and the current route
     *     doesn't have an associated name.
     * @throws \Dimimo\Breadcrumbs\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names
     *     are) not registered.
     */
     ...
     * @throws \Dimimo\Breadcrumbs\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names are) not registered.
     * @throws \Dimimo\Breadcrumbs\Exceptions\UnnamedRouteException if no name is given and the current route doesn't have an associated name.
     * @throws \Dimimo\Breadcrumbs\Exceptions\ViewNotSetException if no view has been set.
     */
     ...
     * @throws \Dimimo\Breadcrumbs\Exceptions\UnnamedRouteException if the current route doesn't have an associated name.
     * @throws \Dimimo\Breadcrumbs\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names are) not registered.
     */
