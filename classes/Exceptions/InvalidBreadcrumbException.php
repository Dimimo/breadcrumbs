...
namespace Dimimo\Breadcrumbs\Exceptions;

use Dimimo\Breadcrumbs\BreadcrumbsException;
...
class InvalidBreadcrumbException extends BreadcrumbsException implements ProvidesSolution
{
    ...
    public function getSolution(): Solution
    {
        ...
        $links = [];
        $links['Defining breadcrumbs'] = 'https://github.com/dimimo/breadcrumbs#defining-breadcrumbs';

        if ($this->isRouteBound) {
            $links['Route-bound breadcrumbs'] = 'https://github.com/dimimo/breadcrumbs#route-bound-breadcrumbs';
        }

        $links['Silencing breadcrumb exceptions'] = 'https://github.com/dimimo/breadcrumbs#configuration-file';
        $links['Laravel Breadcrumbs documentation'] = 'https://github.com/dimimo/breadcrumbs#laravel-breadcrumbs';
