...
class ExceptionsTest extends TestCase
{
    ...
    {
        $this->expectException(\Dimimo\Breadcrumbs\Exceptions\DuplicateBreadcrumbException::class);
    ...
    {
        $this->expectException(\Dimimo\Breadcrumbs\Exceptions\InvalidBreadcrumbException::class);
    ...
    {
        $this->expectException(\Dimimo\Breadcrumbs\Exceptions\ViewNotSetException::class);
